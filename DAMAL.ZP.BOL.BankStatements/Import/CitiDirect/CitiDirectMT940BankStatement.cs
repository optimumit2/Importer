...
{
    public class CitiDirectMT940BankStatement : BankStatementParser
    {
        ...
        protected override void ReadBlocks(StreamReader sr, ref string line)
        {
            try
            {
                ...
                while (line != null && line.Length >= 5 && line.Substring(0, 4) == ":61:")
                {
                    ...
                    {
                        if (line.Length < 4 || line.Substring(0, 4) == ":61:" || line.Substring(0, 5) == ":62F:" ||
                            line.Substring(0, 5) == ":62M:")
                            break;
                        s86 += line.Substring(7);
                    }

                    CitiDirectMT940BankStatementPosition bsPosition = new CitiDirectMT940BankStatementPosition();
        ...
        public override BankStatement GetBankStatement()
        {
            ...
            bankStatement.Content = "Import z systemu CityDirect";
