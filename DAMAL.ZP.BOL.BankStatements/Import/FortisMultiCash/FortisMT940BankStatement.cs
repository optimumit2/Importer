using System;
using System.IO;
using DAMAL.ZP.BOL.BankStatements.Import.MyMultiCash;

namespace DAMAL.ZP.BOL.BankStatements.Import.FortisMultiCash
{
    public class FortisMT940BankStatement : BankStatementParser
    {
        public FortisMT940BankStatement()
        {
            m_Content = "Import z systemu MultiCash";
        }
        ...
        protected override void ReadBlocks(StreamReader sr, ref string line)
        {
            ...
            while (line != null && line.Length >= 5 && line.Substring(0, 4) == ":61:")
            {
                ...
                {
                    if (line.Length < 2 || line.Substring(0, 4) != ":86:")
                        break;
                    s86 += line.Substring(7);
                }

                FortisMT940BankStatementPosition bsPosition = new FortisMT940BankStatementPosition();
