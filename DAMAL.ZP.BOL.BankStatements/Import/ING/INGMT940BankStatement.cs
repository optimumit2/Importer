...
namespace DAMAL.ZP.BOL.BankStatements.Import.ING
{
    public class INGMT940BankStatement : BankStatementParser
    {
        public INGMT940BankStatement()
        {
            m_Content = "Import z systemu ING OnLine";
        }
        ...
        protected override void ReadHeader(StreamReader sr, ref string line)
        {
            ...
            m_BankStatement.BankAccount = line.Substring(7);
        ...
        protected override void ReadBlocks(StreamReader sr, ref string line)
        {
            ...
            while (line != null && line.Length >= 5 && line.Substring(0, 4) == ":61:")
            {
                ...
                INGMT940BankStatementPosition bsPosition = new INGMT940BankStatementPosition();
