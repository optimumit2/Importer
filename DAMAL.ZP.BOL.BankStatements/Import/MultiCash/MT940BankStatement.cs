...
{
    public class MultiCashMT940BankStatement : BankStatementParser
    {
        public MultiCashMT940BankStatement()
        {
        ...
        protected override void ReadBlocks(StreamReader sr, ref string line)
        {
            ...
            while (line != null && line.Length >= 5 && line.Substring(0, 4) == ":61:")
            {
                ...
                MultiCashMT940BankStatementPosition bsPosition = new MultiCashMT940BankStatementPosition();
