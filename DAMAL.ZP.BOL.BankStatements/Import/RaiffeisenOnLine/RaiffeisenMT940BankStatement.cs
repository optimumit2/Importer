...
namespace DAMAL.ZP.BOL.BankStatements.Import.RaiffeisenOnLine
{
    public class RaiffeisenMT940BankStatement : BankStatementParser
    {
        public RaiffeisenMT940BankStatement()
        {
            m_Content = "Import z systemu Raiffeisen OnLine";
        }
        ...
        protected override void ReadBlocks(StreamReader sr, ref string line)
        {
            ...
            while (line != null && line.Length >= 5 && line.Substring(0, 4) == ":61:")
            {
                ...
                RaiffeisenMT940BankStatementPosition bsPosition = new RaiffeisenMT940BankStatementPosition();
