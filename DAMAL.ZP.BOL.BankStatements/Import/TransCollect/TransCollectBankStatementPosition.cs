...
{
    public class  TransCollectBankStatementPosition
    {
        public MT940BankStatementPosition BankStstementPosition;

        public TransCollectBankStatementPosition()
        {
        ...
        public void DecodeData(string s61a, string s86)
        {
            ...
            BankStstementPosition.VirtualId = Convert.ToInt32(s61a.Substring(0, 4));
            s61a = s61a.Remove(0, s61a.IndexOf(",") + 1);
